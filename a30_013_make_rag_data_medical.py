...
def combine_columns(row: pd.Series, dataset_type: str = "medical_qa") -> str:
    """複数列を結合して1つのテキストにする"""
...
def show_usage_instructions(dataset_type: str = "medical_qa") -> None:
    ...
    2. **CSVファイルアップロード**: Question, Complex_CoT, Response 列を含むCSVファイルを選択
